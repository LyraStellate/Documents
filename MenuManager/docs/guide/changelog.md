...
### Fixed
- lilycalInventory未導入の場合に名前空間エラーが発生する問題を修正

## [1.2.0] - 2026-03-15

### Added
- lilycalInventoryに対応
- 上記に伴い`MA`ラベルと`LI`ラベルを追加

### Changed
- ラベル追加によるUIの更新
- カスタムフォルダの明示を先頭ドットから下線に変更

## [1.1.1] - 2026-03-14

### Fixed
- コンポーネントのアイコンのパスが正常に設定されていなかったため修正

## [1.1.0] - 2026-03-14

### Added
- Menu Manager Item Proxyを追加し、スクリプト制御でビルド時にメニューを構築するアセットに対応
...
### Fixed
- カスタムフォルダとアセット由来のフォルダが同名である場合に構築に不備がある問題を修正

## [0.8.5] - 2026-03-06

### Fixed
- Extended使用時に超過フォルダがずれる問題を修正
...
### Changed
- 依然として残っていた第3階層以上のデータが強制的に解体される問題を修正
...
- 無料版での保存時に第3階層以上のデータが強制的に解体される問題を修正
